...
const MakeAppointment = () => {
  return (
    <section
      className="max-w-7xl mx-auto rounded-md mt-20 lg:mt-40 flex lg:flex-row items-center"
      style={{ background: `url(${appointmentBg})` }}>
      <img
        src={doctor}
        alt="doctor"
        className="-mt-32 hidden lg:block lg:w-[54%] lg:h-[75vh]"
      />
      <div className="p-10">
        <div className="text-white">
          ...
          <p className="text-white/90 text-lg leading-relaxed mb-2">
            Schedule your dental appointment with ease. Our experienced team is
            ready to provide you with exceptional care in a comfortable
            environment.
          </p>
